...
<body class="bg-[#021908] text-[#021908] h-screen flex flex-col md:flex-row">
  ...
  <div class="p-4 font-semibold text-xl border-b border-[#BBCB2F] select-none flex items-center gap-3">
    ...
    <button
      ...
      type="button"
    >
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18l-6-6 6-6"/></svg>
      Back
    </button>
    Chats
  </div>
  ...
  <div class="flex flex-col flex-grow">
    ...
    <form id="messageForm" class="p-4 border-t border-[#BBCB2F] flex items-center gap-3 bg-[#F9FAF8]">
      ...
      <button type="button" id="attachFileBtn" class="text-[#BBCB2F] hover:text-[#FEFA95] transition" aria-label="Attach file" title="Attach File">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><path d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.586-6.586a4 4 0 10-5.656-5.656l-6.586 6.586a6 6 0 108.485 8.485L20.5 13"/></svg>
      </button>
      ...
      <button type="button" id="attachImageBtn" class="text-[#BBCB2F] hover:text-[#FEFA95] transition" aria-label="Insert image" title="Attach Image">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg>
      </button>
