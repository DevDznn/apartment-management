...
<body class="bg-[#021908] text-[#021908] h-screen flex flex-col md:flex-row">
  ...
  <section class="flex flex-col flex-1 bg-[#FFFFFF] h-1/2 md:h-full relative">
    ...
    <!-- Chat Header -->
    <header id="chatHeader" class="p-5 border-b border-[#BBCB2F] flex items-center gap-4 select-none pt-12 md:pt-5">
    ...
    <form id="messageForm" class="p-4 border-t border-[#BBCB2F] flex items-center gap-3 bg-[#F9FAF8]">
      ...
      <button type="button" id="attachFileBtn" class="text-[#BBCB2F] hover:text-[#FEFA95] transition" title="Attach File">
      ...
      <button type="button" id="attachImageBtn" class="text-[#BBCB2F] hover:text-[#FEFA95] transition" title="Attach Image">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      ...
      <input id="messageInput" type="text" placeholder="Type your message..." autocomplete="off" class="flex-grow p-2 rounded-lg border border-[#BBCB2F] focus:outline-none focus:ring-2 focus:ring-[#BBCB2F]" disabled />
      <button type="submit" class="bg-[#BBCB2F] hover:bg-[#BBCB2F]/90 p-2 rounded-lg text-[#021908] font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition" disabled>Send</button>
    </form>
  </section>
